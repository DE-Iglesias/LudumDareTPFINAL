...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/GordoNarizSS.png", __ASSET__assets_images_gordonarizss_png);
		type.set ("assets/images/GordoNarizSS.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/GordoNarizSS.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_gordonarizss_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/GordoNarizSS.png") #if display private #end class __ASSET__assets_images_gordonarizss_png extends lime.graphics.Image {}
