...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Deei", "Juego10", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Juego10";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Juego10", null, { width: 640, height: 480 });
